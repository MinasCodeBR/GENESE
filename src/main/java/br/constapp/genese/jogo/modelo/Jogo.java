...
public class Jogo implements Externalizable {
	...
	public String toString() {
		...
		return Calc.zeroToLeft(primeiraDezena) + "   " + Calc.zeroToLeft(segundaDezena) + "   "
				+ Calc.zeroToLeft(terceiraDezena) + "   " + Calc.zeroToLeft(quartaDezena) + "   "
				+ Calc.zeroToLeft(quintaDezena) + "   " + Calc.zeroToLeft(sextaDezena);
	}
